...
Несмотря на то, что у сайта всего 2 страницы, я использованы как шаблон "base", так и включение "include".
...
На такущий момент не отображаются картинки из БД. 
Тест странный. всегда говорит 200. 
